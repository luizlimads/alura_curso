...
# operacoes em conjunto > set{}
usuarios_data_science | usuarios_machine_learning # uniao

usuarios_data_science & usuarios_machine_learning # inserccao

usuarios_data_science - usuarios_machine_learning # diferenca

usuarios_data_science ^ usuarios_machine_learning # exclusivo
...
usuarios.add(134) # erro nao tem metodo add
...
aparicoes["Guilherme"] # busca por chave
aparicoes["xpto"] # erro nao tem a chave
aparicoes.get("xpto", 0) # retorna 0 caso nao encontre a chave

aparicoes = dict(Guilherme = 2, cachorro = 1) # chamando dict pelo construtor
...
aparicoes["Carlos"] = 1 # dict mutavel

del aparicoes["Carlos"] # apagando por chave
...
for chave, valor in aparicoes.items(): # forma retorna elemento chave e valor
  print(chave, "=", valor)

meu_texto = "Bem vindo meu nome é Guilherme eu gosto muito de nomes e tenho o meu cachorro e gosto muito de cachorro"

# defaultdict 0 caso nao encontre int() é uma funcao
from collections import defaultdict

aparicoes = defaultdict(int)
# contando frequencia absoluta de palavras
for palavra in meu_texto.split():
  ate_agora = aparicoes[palavra]
  aparicoes[palavra] = ate_agora + 1

dicionario = defaultdict(int)
dicionario['guilherme'] # valor retornado 0 pois nao existe a chave no dicionario criado

# forma mais resumida de contar frequencia de palavras
aparicoes = defaultdict(int)
for palavra in meu_texto.split():
  aparicoes[palavra] += 1
aparicoes
...
# pode ser passado um objeto na funcao do defaltdict
...
# contando frequencia de aparicoes das palavras
aparicoes = Counter()
for palavra in meu_texto.split():
  aparicoes[palavra] += 1
aparicoes
